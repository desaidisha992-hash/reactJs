  ...
  return (
    ...
    <section className='flex items-end justify-center w-full'>  
     ...
     <div className='w-1/2 flex flex-col justify-end items-start gap-y-25'>
        ...
        <button className='text-[14px] text-white bg-black px-3 py-1 rounded-lg'>Get Unplash+</button>
     </div>
     ...
     <div className='relative w-1/2'>
       ...
       {/* chip 1 */}    
       <div className='flex items-center justify-center gap-x-1 absolute z-10 top-32 left-18 border border-gray-200 rounded-full px-2 py-1 bg-white font-normal text-[12px]'><CircleCheck fill="green" className='text-white w-5 h-5'/>Worry-free Licensing</div>
       {/* chip 2 */}
       <div className='flex items-center justify-center gap-x-1 absolute z-10  text-[12px] border border-gray-200 px-2 py-1 rounded-full bg-white top-44 -left-6'><CircleCheck fill="green" className='text-white w-5 h-5'/>Cleared for all uses</div>
